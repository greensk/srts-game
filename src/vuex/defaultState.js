export default function () {
  ...
  return {
    ...
    healthValidFoodDelta: 5, // на сколько увеличивается здоровье при поедании своей еды
    healthInvalidFoodDelta: -5, // на сколько увеличивается здоровье при поедании не своей еды
